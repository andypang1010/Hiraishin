...
public class PlayerLocomotionState : PlayerBaseState
{
    ...
    public PlayerLocomotionState(PlayerController controller, PlayerStateMachine stateMachine, PlayerData data) : base(controller, stateMachine, data)
    {
    }
    ...
    public override void LogicUpdate() {
        ...
        moveDirection = (controller.transform.right * walkInput.x + controller.transform.forward * walkInput.y).normalized;
    }
